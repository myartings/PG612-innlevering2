...
private:
	...
	glm::quat view_matrix_old; //View matrix that represents the old camera position
	glm::quat view_matrix_new; //View matrix that represents the new camera position
